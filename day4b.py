    ...
    if len(numbers) == 6:
        ...
        if currentGuard not in guardDict:
            ...
            for eachmin in range(0,60):
                highestMinDict[currentGuard][eachmin] = 0
        #print(highestMinDict[currentGuard])
        ...
        if line[19:20] == 'f':
            ...
            for eachmin in range(starttime,endtime+1):
                highestMinDict[currentGuard][eachmin] += 1
            print(highestMinDict[currentGuard])
...
for key, value in highestMinDict.items():
    print(key,value)
    highst = keywithmaxval(value)
    print("highest min {} at {} times".format(highst,highestMinDict[key][highst]))
    print()
